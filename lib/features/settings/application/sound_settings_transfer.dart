...
const Map<String, String> _customSoundKeys = <String, String>{
  ...
  WorkoutSoundCue.moveCountdown: 'moveCountdownCustomSound',
  WorkoutSoundCue.moveHalfway: 'moveHalfwayCustomSound',
  WorkoutSoundCue.moveFinished: 'moveFinishedDingCustomSound',
  WorkoutSoundCue.restFinished: 'restFinishedCustomSound',
...
Map<String, dynamic> encodeSoundSettings(AppSettings settings) {
  ...
  final Map<String, CustomWorkoutSound?> selectedSounds =
    ...
    WorkoutSoundCue.moveCountdown: settings.moveCountdownCustomSound,
    ...
    WorkoutSoundCue.restFinished: settings.restFinishedCustomSound,
